...
@section('content')
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-16">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-3xl font-bold text-white tracking-tight">Tambah Barang Baru</h1>
            <p class="text-gray-400 text-sm mt-1">Masukkan spesifikasi dan jumlah unit perangkat lab baru.</p>
        </div>
        ...
        <div class="bg-[#121618] border border-white/10 rounded-2xl p-6 sm:p-8 shadow-xl">
            <form action="{{ route('products.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="nama" value="{{ old('nama') }}" placeholder="Masukkan Nama Barang"
